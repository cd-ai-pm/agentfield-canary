...
module "terraform_digitalocean_kubernetes" {
  source = "git::https://github.com/cd-ai-pm/terraform-digitalocean-kubernetes.git?ref=dependabot/github_actions/clouddrove/github-shared-workflows/dot-github/workflows/stf-checks.yml-0d9fa74b29d820d7ffe031704ec53bf7653c97c3"
}
