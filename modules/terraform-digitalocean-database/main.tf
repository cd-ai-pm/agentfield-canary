...
module "terraform_digitalocean_database" {
  source = "git::https://github.com/cd-ai-pm/terraform-digitalocean-database.git?ref=dependabot/github_actions/clouddrove/github-shared-workflows/dot-github/workflows/tf-lint.yml-21cd5a8d11a5f01560103ac3fcae05835e9e3699"
}
